...
<body>
<!--<form method="post" enctype="multipart/form-data" action="ManagePaperActionDSN.php">-->
<form method="post" enctype="multipart/form-data" action="index.php?content_page=ManagePaperActionDSN">
<table>
  <tr>
    <td>Title:</td>
